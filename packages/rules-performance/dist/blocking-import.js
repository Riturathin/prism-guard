    ...
    run(context) {
        ...
        (0, traverse_1.default)(context.ast, {
            ImportDeclaration(path) {
                ...
                if (matched) {
                    diagnostics.push((0, core_1.createDiagnostic)(exports.blockingImportRule, context.file, path.node, `Heavy library "${matched}" imported synchronously`, "Use dynamic import() or import specific submodules to reduce bundle size"));
                }
            }
        });
        return diagnostics;
